  ...
  return (
    <>
      <section className="w-full min-h-screen flex flex-col items-center bg-gray-100">
        <div className="relative w-full h-52 bg-cover bg-no-repeat bg-center bg-[url('/images/mentors.jpg')] md:h-100">
        ...
        <div className="w-full px-8 py-10 flex items-center justify-center gap-10">
          ...
          <div className="md:w-[43%] py-10 relative">
            ...
            <p className="text-lg text-black max-w-2xl mx-auto px-4 py-8 relative z-10 [word-spacing:0.2em] tracking-wider">
              ...
              independence, or just needing someone who understands, a mentor
        ...
        <div className="w-full h-fit px-4 mt-6 sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {mentorDuties.map((duty) => (
            <div
              key={duty.id}
              className="w-full h-fit px-4 py-6 rounded-2xl bg-[#B89B5E]  mb-4 border-dashed border-1 border-[#B89B5E]  hover:shadow-lg transition duration-300 md:h-[19rem]"
            >
              <img
            ...
            {skillEnhancements.map((enhancement) => {
              ...
              return (
                <div
                  ...
                  className="w-full h-fit md:h-[7rem] px-4 py-3 rounded-2xl bg-[#B89B5E]/80 border-[#B89B5E]  mb-4 border-3 hover:shadow-lg transition duration-300 flex items-center justify-start gap-4 md:py-6"
                >
